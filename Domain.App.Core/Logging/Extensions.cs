...
public static class Extensions
{
    ...
    {
        app.UseSerilogRequestLogging(options => options.GetLevel += (context, elapsed, ex) =>
    ...
    {
        IExceptionDestructurer[] destructurers = [new DbUpdateExceptionDestructurer(), new SqlExceptionDestructurer()];
